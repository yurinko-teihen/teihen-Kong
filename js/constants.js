...
// === 敵・ポリーンの配置 ===
const DONKEY_KONG_X = 310; // ドンキーコングのX座標
const DONKEY_KONG_Y = 8;   // ドンキーコングのY座標
const PAULINE_X     = 40;  // ポリーンのX座標
const PAULINE_Y     = 129; // ポリーンのY座標

// === フォント ===
const FONT_TITLE = '24px Arial'; // 大見出し用フォント
const FONT_BODY  = '18px Arial'; // サブテキスト用フォント
const FONT_SCORE = '20px Arial'; // スコア表示用フォント
